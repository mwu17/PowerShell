...
$global:SCOMMgmtSvr = "YourManagementServer.yourDomainName"
...
# List All Scheduled Job for Maintenance Mode
function get-allSchedule() {
    $MMGrid2.clear()
    $SchObjs = @()
    $allScheJob = Get-ScheduledJob -ErrorAction SilentlyContinue
    foreach ($scheJob in $allScheJob) {
        $obj = [PSCustomObject]@{
            ServerName    = $scheJob.name
            ScheduledTime = ($scheJob|Get-JobTrigger).At
        }
        $SchObjs += $obj
    }
    $MMGrid2.ItemsSource = $SchObjs
}
...
# Validate Domain Account Password
function check-domainCred () {
    [CmdletBinding()]
    param(
        $domainCred
    )
        ...
        <TabControl x:Name="tabControl" HorizontalAlignment="Left" Height="416" VerticalAlignment="Top" Width="899">
            <TabItem Header="Start Maintenance Mode">
                <Grid Background="#FFE5E5E5">
                    ...
                    <GroupBox x:Name="groupBox6" Header="Schedule Start Time : " HorizontalAlignment="Left" Height="69" Margin="21,187,0,0" VerticalAlignment="Top" Width="334" FontSize="14" Grid.ColumnSpan="2">
                        <Button x:Name="TimePickButton2" Content="Select" HorizontalAlignment="Left" Height="25" Margin="261,10,0,0" VerticalAlignment="Top" Width="55" Background="#FF4F4848" Foreground="White" FontWeight="Bold"/>
                    </GroupBox>
                    <TextBox x:Name="serverName" HorizontalAlignment="Left" Height="25" Margin="33,24,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="277" FontSize="14" Grid.ColumnSpan="2"/>
                    <Button x:Name="search" Content="Search" HorizontalAlignment="Left" Height="25" Margin="112,24,0,0" VerticalAlignment="Top" Width="119" FontWeight="Bold" FontSize="14" Foreground="White" BorderBrush="#FF403B3B" Background="#FF4F4848" Grid.Column="1"/>
                    <DataGrid x:Name="serverGrid" HorizontalAlignment="Left" Height="114" Margin="33,59,0,0" VerticalAlignment="Top" Width="826" Background="#FFF0F0F0" BorderThickness="0" Grid.ColumnSpan="2"/>
                    <TextBox x:Name="duration" HorizontalAlignment="Left" Height="24" Margin="166,218,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="109" FontSize="14" Grid.Column="1"/>
                    <GroupBox x:Name="groupBox1" Header="Name : " HorizontalAlignment="Left" Height="182" Margin="21,0,0,0" VerticalAlignment="Top" Width="846" FontSize="14" Grid.ColumnSpan="2">
                    ...
                    <GroupBox x:Name="groupBox2" Header="Duration (minutes) : " HorizontalAlignment="Left" Height="69" Margin="145,187,0,0" VerticalAlignment="Top" Width="147" FontSize="14" Grid.Column="1"/>
                    <GroupBox x:Name="groupBox3" Header="Specific End Time : " HorizontalAlignment="Left" Height="69" Margin="308,187,0,0" VerticalAlignment="Top" Width="342" FontSize="14" Grid.Column="1">
                        <Button x:Name="TimePickButton" Content="Select" HorizontalAlignment="Left" Margin="267,10,0,0" VerticalAlignment="Top" Width="55" Height="25" Foreground="#FFF7F7F7" Background="#FF4F4848" FontWeight="Bold"/>
                    </GroupBox>
                    <GroupBox x:Name="groupBox4" Header="Reason : " HorizontalAlignment="Left" Height="89" Margin="66,276,0,0" VerticalAlignment="Top" Width="290" FontSize="14" Grid.Column="1">
                        <ComboBox x:Name="reason" HorizontalAlignment="Left" Height="22" Margin="7,23,0,0" VerticalAlignment="Top" Width="263">
                    ...
                    <GroupBox x:Name="groupBox5" Header="Comments : " HorizontalAlignment="Left" Height="89" Margin="21,276,0,0" VerticalAlignment="Top" Width="257" FontSize="14" Grid.ColumnSpan="2">
                        <TextBox x:Name="comment" HorizontalAlignment="Left" Height="50" Margin="10,10,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="226" HorizontalScrollBarVisibility="Auto" VerticalScrollBarVisibility="Auto"/>
                    </GroupBox>
                    <Button x:Name="start" Content="Start Maintenance Mode" HorizontalAlignment="Left" Height="73" Margin="375,292,0,0" VerticalAlignment="Top" Width="247" FontSize="18" FontWeight="Bold" Background="#FF19A626" Foreground="White" BorderBrush="White" Grid.Column="1"/>
                    <TextBox x:Name="ScheduledEndTime" HorizontalAlignment="Left" Height="25" Margin="327,217,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="246" IsReadOnly="True" Grid.Column="1"/>
                    <TextBox x:Name="ScheduledStartTime" HorizontalAlignment="Left" Height="25" Margin="36,217,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="246" IsReadOnly="True" Grid.ColumnSpan="2"/>
                </Grid>
            </TabItem>
            ...
            <TabItem Header="Scheduled Maintenance Mode">
                <Grid Background="#FFE5E5E5">
                    <DataGrid x:Name="MMGrid2" HorizontalAlignment="Left" Height="268" Margin="32,29,0,0" VerticalAlignment="Top" Width="830"/>
                    <Button x:Name="stopSchedule" Content="Stop Scheduled MM" HorizontalAlignment="Left" Height="37" Margin="508,322,0,0" VerticalAlignment="Top" Width="212" FontWeight="Bold" FontSize="14" Background="#FF9B0829" Foreground="White" BorderBrush="White"/>
                    <Button x:Name="refresh2" Content="Refresh" HorizontalAlignment="Left" Height="37" Margin="742,322,0,0" VerticalAlignment="Top" Width="120" FontSize="14" FontWeight="Bold" Background="#FF4F4848" Foreground="White" BorderBrush="#FFFBFBFB"/>
                    <GroupBox x:Name="groupBox10" Header="Secheduled Maintenance Mode Servers" HorizontalAlignment="Left" Height="306" Margin="18,5,0,0" VerticalAlignment="Top" Width="856" FontSize="14"/>
                </Grid>
            </TabItem>
        </TabControl>
...
$scheduledStartTime = $win.findname("ScheduledStartTime")
$TimePickButton2 = $win.findname("TimePickButton2")
$MMGrid2 = $win.findname("MMGrid2")
$stopSchedule = $win.findname("stopSchedule")
$refresh2 = $win.findname("refresh2")
...
$start.Add_Click( {
        ...
        elseif ($duration.text -eq "" -and $scheduledEndTime.text -eq "") {
            ...
            # Schedule a Maintenance Mode
            else {
                $startTime = $scheduledStartTime.text -as [datetime]
                $displayText = "
            Are you sure to schedule a Maintenance Mode?
            Server: $selectedItem
            ...
            Comment: $($comment.text)
            "
                $confirm = [System.Windows.Forms.MessageBox]::Show($displayText , "Schedule Maintenance Mode" , 1)
                if ($confirm -eq "OK") {
                    # check domain acccount password
                    do {
                        $userID = whoami
                        $SAcred = Get-Credential $userid -Message "Please Enter your Domain account password."

                    } until (check-domainCred -domainCred $SAcred -ErrorAction SilentlyContinue)
                    ...
                    Write-Host "The Scheduled Job $selectedItem has been scheduled." -ForegroundColor Green
                    [System.Windows.Forms.MessageBox]::Show("Schedule Maintenance Mode Started" , "Maintenance Mode", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Asterisk)
                    clearAll
                    get-allSchedule
                }
            }
...
$stopSchedule.add_Click( {
        $selectJob = $MMGrid2.Selecteditem.serverName
        $confirm = [System.Windows.Forms.MessageBox]::Show("Are you sure to STOP the Scheduled Maintenance Mode on $selectJob ?" , "Stop Scheduled Maintenance Mode" , 1)
        if ($confirm -eq "OK") {
            Unregister-ScheduledJob -Name $selectJob -Verbose
            [System.Windows.Forms.MessageBox]::Show("Scheduled Maintenance Mode Stoped" , "Scheduled Maintenance Mode", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Asterisk)
            # Refresh
            get-allSchedule
        }
...
$TimePickButton2.Add_Click( {
        $scheduledEndTime.clear()
        $endtime = Schedule-TimeForm
        $scheduledStartTime.text = $endtime
    })
